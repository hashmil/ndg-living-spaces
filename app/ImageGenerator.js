...
export default function ImageGenerator() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4">
      <div className="w-full max-w-md h-[calc(100vh-2rem)] flex flex-col gap-4">
        {/* Image Container */}
        <div className="glass-panel relative w-full flex-1 max-h-[calc(100vh-12rem)] mx-auto overflow-hidden">
          {loading ? (
            <div className="absolute inset-0 flex flex-col items-center bg-black bg-opacity-50">
              <div className="flex flex-col items-center h-full">
                <div className="spinner mt-[30%]" />
                <div className="font-medium text-white capitalize mt-6">
                  {status}
                </div>
              </div>
            </div>
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-white/60">
              <div className="w-[20%] aspect-[9/16] flex items-center justify-center">
                <svg
